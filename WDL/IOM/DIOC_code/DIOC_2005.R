...
DIOC_2005_raw$age_cen = paste0 (DIOC_2005_raw$age_cen, "_cen")
DIOC_2005_raw$age_lfs = paste0 (DIOC_2005_raw$age_lfs, "_lfs")

DIOC_2005_raw = transform (DIOC_2005_raw, age = ifelse (!(age_cen == "NA_cen"), age_cen, age_lfs))

DIOC_2005_1 = DIOC_2005_raw %>%
  dplyr::select(-c("edu_cen", "age_cen", "age_lfs", "reg_oecd_2000", "reg_oecd_2010")) %>%
  rename_with (
    ~ case_when (
      . == "country" ~ "dest",
      . == "coub" ~ "orig",
...
DIOC_2005_5$total_shares <- rowSums (DIOC_2005_5 [,6:21], na.rm = T)
DIOC_2005_5$others = rowSums (DIOC_2005_5[,c(9,13:21)], na.rm = T)

DIOC_2005_6 = DIOC_2005_5 %>% dplyr::select (-c(9,13:21)) %>% relocate (others, .before = total_shares)

# cleaning environment
DIOC_2005 = DIOC_2005_6
rm (DIOC_2005_1, DIOC_2005_2, DIOC_2005_3, DIOC_2005_4, DIOC_2005_5, DIOC_2005_6, DIOC_2005_total)
