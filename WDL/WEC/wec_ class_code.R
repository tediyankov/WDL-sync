...
sum (wec_classification$pop [wec_classification$income_class == "middle income" & 
                               wec_classification$emissions_class == "middle emissions" & 
                               wec_classification$year == 2023])


sum (wec_classification$emissions [wec_classification$income_class == "middle income" & 
                               wec_classification$emissions_class == "middle emissions" & 
                               wec_classification$year == 2023])

nrow (wec_classification %>% filter (income_class == "middle income" & 
                                       emissions_class == "middle emissions" & 
                                       year == 2023))


wec_classification2023 = wec_classification %>% filter (year == 2023) %>% mutate (country = countrycode (iso3c, "iso3c", "country.name"))

list <- countrycode (unique (wec_classification2023$iso3c [wec_classification2023$income_class == "middle income" & 
                                                             wec_classification2023$emissions_class == "low emissions"]), 
                     "iso3c", 
                     "country.name")


list2 = wec_classification2023$country [wec_classification2023$income_class == "high income" & 
                                          wec_classification2023$emissions_class == "high emissions"]
list2
